...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.DELETE,"/api/question/**").hasAnyRole("ROLE_SUPERVISOR")
                .antMatchers("/api/category/**").permitAll()
                .antMatchers(HttpMethod.GET,"/api/category/**").permitAll()
                .antMatchers(HttpMethod.DELETE,"/api/category/**").hasAnyRole("ROLE_ADMIN")
                .antMatchers(HttpMethod.PUT,"/api/category/**").hasAnyRole("ROLE_ADMIN")
                .antMatchers(HttpMethod.PUT,"/api/category/**").hasAnyRole("ROLE_SUPERVISOR")
                .antMatchers(HttpMethod.GET,"/api/answer/**").permitAll()
                .antMatchers("/api/answer/**").permitAll()
                .antMatchers(HttpMethod.POST,"/api/answer/**").hasAnyRole("ROLE_SUPERVISOR")
                .antMatchers("/api/user/**").permitAll()
                .antMatchers(HttpMethod.DELETE,"/api/user/**").hasAnyRole("ROLE_ADMIN")
